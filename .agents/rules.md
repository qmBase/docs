...
- All documentation content must be written in German (de-DE)
- AI must not introduce English sentences or headings
- UI labels may remain in English if they reflect the product UI
...
- Preserve existing terminology exactly
