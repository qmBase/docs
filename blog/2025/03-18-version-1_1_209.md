...
Funktionen zu testen. Bitte melden Sie sich hierzu unter [support@qmbase.com](mailto:support@qmbase.com), damit wir Sie hierfür freischalten können. Weiter Informationen darüber, was die **qmBase AI** kann finden Sie [hier](/docs/general/common-features#-qmbase-ai).
