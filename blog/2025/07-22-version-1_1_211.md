...
- **On-Premises** Nutzer bitte beachten. Wenn Sie schon länger qmBase im Einsatz haben, müssen Sie eine Konfigurationsdatei auf Ihrem Server nach diesem Update anpassen. Weitere Informationen finden Sie [hier](/docs/technical/self-hosting/upgrade-guide).
