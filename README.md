...
| Entity \ Entity     | AbsenceRequest | ApplicationUser | Article | Audits | Claim | Company Function | Defect | Department Position                                                | Document | Forms | Goals | Idea | InventoryItem | Organization | Product | Qualification | Risk or Chance | Tasks | Tenants                                     | Training |
| ------------------- | -------------- | --------------- | ------- | ------ | ----- | ---------------- | ------ | ------------------------------------------------------------------ | -------- | ----- | ----- | ---- | ------------- | ------------ | ------- | ------------- | -------------- | ----- | ------------------------------------------- | -------- | --- |
| AbsenceRequest      |                | ✅              | ✅      |        | ✅    |                  |        | ✅                                                                 | ✅       |       |       |      |               | ✅           |         |               |                |       | ✅                                          |          |
| ApplicationUser     |                |                 | ✅      |        | ✅    |                  |        | ✅                                                                 | ✅       |       |       |      |               | ✅           |         |               |                |       |                                             |          |
| Article             | ✅             | ✅              | ✅      | ✅     | ✅    | ✅               | ✅     | ✅                                                                 | ✅       | ✅    | ✅    | ✅   | ✅            | ✅           | ✅      | ✅            | ✅             | ✅    | ✅                                          | ✅       |
