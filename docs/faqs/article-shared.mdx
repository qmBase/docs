...
Die beteiligten Personen und Rollen sind im [Dokumentenmanagement](/docs/document-management), [Wiki](/docs/wiki) und [Blog](/docs/blog) identisch:
...
Die Erstellung von Artikeln erfolgt im [Dokumentenmanagement](/docs/document-management), [Wiki](/docs/wiki) und [Blog](/docs/blog) analog.
