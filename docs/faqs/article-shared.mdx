...
Der Verantwortliche wählt eine oder mehrere Personen zur Genehmigung des Dokuments aus. Im Anschluss wird der Veröffentlichungsprozess gestartet durch einen Klick auf den Button <code>Veröffentlichung starten</code>. Danach erhalten die Freigeber eine automatische E-Mail-Benachrichtigung, dass für Sie ein Artikel zur Freigabe vorliegt.
