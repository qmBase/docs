...
Im Menü in der Kopfleiste können unter CRM -> Organisationen* mit dem Button *Neu* neue Kontakte erstellt werden. Auf der Detailseite eines Kontakts lässt sich dieser als Kunde und/oder Lieferant markieren. Anschließend können die Kunden und Lieferanten z.B. im Rahmen der Lieferantenbewertung oder der Kundenzufriedenheitsanalyse bewertet werden. 
