...
| --------------------------------------------- | ------------ | -------------------------------------------------------------------- |
| https://qmadmin.qmbase.com                    | 20.50.2.7    | Subscription management, Ticket System                               |
| https://qmbasestore.azurewebsites.net         | 13.69.68.47  | Access to qmBase Templates                                           |
| https://qmbasesupport.blob.core.windows.net/  | n/a          | Access to qmBase Templates                                           |
| https://qmbase-armfunctions.azurewebsites.net | 20.50.2.41   | Central user management                                              |
| https://qmbasefunctions.azurewebsites.net     | 13.94.211.38 | Recurring weekly notifications and web calendar functionality        |
| https://api.sendgrid.com                      | n/a          | E-Mail notifications                                                 |
| https://caqadmin.blob.core.windows.net        | n/a          | Software Updates                                                     |
| https://js.monitor.azure.com                  | n/a          | Azure Monitor tracks availability and performance of the application |
