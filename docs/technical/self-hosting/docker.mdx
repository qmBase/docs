...
1. **Create the .env Files**
   ...
   ```bash
   curl -o .env.web https://raw.githubusercontent.com/qmBase/deployment/refs/heads/main/src/pbd-core/.env.example
   ```
...
If you encounter any problem, check [Troubleshooting](./on-prem.mdx) for solutions.
