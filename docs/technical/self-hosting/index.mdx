...
There are several ways to self-host the application, this documentation focuses on the [Docker](docker.mdx) deployment method which is the most common and recommended approach. 
For other deployment methods, please refer to the [Installation Windows](./install-windows.mdx) documentation.
