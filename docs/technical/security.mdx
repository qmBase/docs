...
qmBase currently processes and stores customer information with providers that can be found in the Data processing agreement (DPA).
...
The workload responsibilities vary depending on whether the workload is hosted on Software as a Service (SaaS) or in an on-premises datacenter:

#### Responsibility Matrix

| Responsibility area         | On-premises | SaaS     |
| --------------------------- | ----------- | -------- |
| Customer data               | Customer    | Customer |
| Configurations and settings | Customer    | Customer |
| Identities and users        | Customer    | Customer |
| Client devices              | Customer    | Shared   |
| Applications                | Customer    | Shared   |
| Network controls            | Customer    | qmBase   |
| Operating system            | Customer    | qmBase   |
| Physical hosts              | Customer    | qmBase   |
| Physical network            | Customer    | qmBase   |
| Physical datacenter         | Customer    | qmBase   |

#### Responsibilities you always retain

Regardless of the type of deployment, you always retain the following responsibilities:

- Data - You're responsible for your data, including data classification, data protection, and compliance with data governance requirements.
...
Some responsibilities are shared between you and qmBase, with the division varying by service model:

- Applications - In On-premises, you're fully responsible for deployed applications. In SaaS, qmBase manages parts of the application stack, but you're responsible for application configuration, code security, and access controls.
- Network controls - In On-premises, you configure all network security including firewalls and network segmentation. In SaaS, qmBase manages network security.
- Client devices - In SaaS scenarios, qmBase may provide some device management capabilities, but you're responsible for endpoint protection and compliance.

#### qmBase responsibilities

qmBase is responsible for the underlying cloud infrastructure, which includes:
...
- Platform services - In SaaS, qmBase manages operating systems, runtime environments, and middleware.
