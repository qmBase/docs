...
We understand how important the responsibility to protect data is to our clients.
...
qmBase currently processes and stores customer information with providers that can be found in <!-- this [list](/docs/technical/subprocessors) --> the Auftragsverarbeitungsvertrag (AVV).
...
We place strict controls over our employees’ access to the data you and your users make available via the qmBase services and are committed to ensuring that customer data is not seen by anyone who should not have access to it.
