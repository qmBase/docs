...
1. **Übersicht öffnen**: Die Offboarding-Übersicht listet Ihre Mitarbeiter auf. Standardmäßig werden dabei die bereits gelöschten Mitarbeiter (Papierkorb) angezeigt, also genau die Personen, bei denen typischerweise noch aufgeräumt werden muss. 
