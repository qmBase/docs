...
Hier finden Sie eine Auflistung aller durch das System verschickten E-Mails.

## Integrationen

Sind für Ihre qmBase System Schnittstellen zu anderen System erstellt worden, finden Sie hier weitere Informationen dazu.
...
Übersicht aller in qmBase hochgelanden Dateien.

## Kosten

Übersicht aller in qmBase erfassten Kosten.

## Backup

Unter dem Menüpunkt Backup können Sie ein Backup anfragen. Der Prozess für die Erstellung von Backups ist ein langlaufender Prozess. Sie erhalten eine Benachrichtigung darüber, wenn das Backup fertigestellt ist.
Das Ausführen des Backups ermöglicht es Ihnen den aktuellen Stand Ihres qmBase Systems lokal auf Ihrer Infrastruktur auszuführen.
Zur Installation von qmBase schauen Sie bitte in unsere [Hilfe zur Installation](/docs/technical/installation) oder wenden sich an den [Support](mailto:support@qmbase.com).
