...
Um den Zugriff einzuschränken, können Sie hier festlegen mit welchen E-Mail Domains sich neue Nutzer anmelden können. Tragen Sie z.B. @firma.de ein, damit sich max.mustermann@firma.de als neuer Nutzer registrieren kann.
