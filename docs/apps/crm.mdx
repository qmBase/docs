...
import { FaChessKing, FaListUl, FaPlus, FaShippingFast, FaStarHalfAlt } from "react-icons/fa";
...
<CommonFunction app={`Crm`} entity={`OrganisationRating`} entityTitle={`Bewertungen`} />
