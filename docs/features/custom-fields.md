...
Zum Erstellen der Custom Fields wechseln Sie einfach in der jeweiligen App in die Einstellungen und klicken Sie Custom Fields. Über das "+" oben rechts haben Sie die Möglichkeit ein neues Custom Field zu erstellen.
...
Die erstellten Custom Fields können Sie dann optional bei den vorhandenen Formularen einfügen.
...
- **Bewertung:** Bewertungsfeld mit Sternen
- **Formel:** Berechnetes Feld, das auf anderen Feldern basiert
...
Ein wichtiger Punkt bei dieser Anpassung kann z.B. der Zugriff auf Custom Fields nur für spezielle Nutzer sein.
...
Wechseln Sie in die Einstellungen > Reklamationsmanagement > Custom Fields. Hier können Sie jetzt das Custom Field auswählen, das mit der Einschränkung versehen werden soll.
