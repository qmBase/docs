...
import { FaCog, FaFilter, FaSearch, FaEllipsisV, FaColumns } from "react-icons/fa";
...
Vermeiden Sie doppelte Erfassung von Daten. Bei vielen Informationen, wie z.B. Maßnahmen oder Qualifikationen, werden im Moment des Erfassens die neuen Titel mit bereits vorhandenen Titeln verglichen.
Bei starker Übereinstimmung, werden die Treffer als mögliche Duplikate unterhalb des Titel Eingabefelds angezeigt. Berücksichtigt werden hierbei jeweils nur Einträge, die nicht gelöscht sind.
Sofern ein Statusfeld vorhanden ist, werden auch nur Einträge, deren Status noch nicht **Abgeschlossen** ist, verglichen.

## Anhänge

Bei allen wichtigen Objekten, wie z.B. Reklamationen, können Anhänge hinzugefügt werden. Diese sind z.B. hilfreich, wenn Sie bei einer Reklamation den Schaden mit einem Bild dokumentieren möchten.
...
Zusätzlich können Sie über die erweiterten Tabellenoptionen beliebig Spalten der Tabelle ein- und ausblenden.
